...
CC = icc
PGC = pgc++ -acc -ta=tesla:managed -DUSE_ACC -fPIC -Minfo
LDFLAGS += -fopenmp -O3
...
#propagate : propagate-toz-test-main.o propagate-toz-test.o propagateGPU.o
#	$(PGC) $(CUDALDFLAGS) -o propagate propagate-toz-test.o propagate-toz-test-main.o propagateGPU.o
propagate-toz-test.o : propagate-toz-test.C propagate-toz-test.h
	$(CC) $(LDFLAGS) $(CXXFLAGS) -o propagate-toz-test.o -c propagate-toz-test.C
...
#	$(PGC) -o propagate-toz-test-main.o -c propagate-toz-test-main.cc
propagate-toz-test-main.o : propagate-toz-test-main.cc propagate-toz-test.h
