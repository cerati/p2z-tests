...
inline void KalmanGainInv2(const Accessor1 &a, const Accessor2 &b, MP3x3_ &c, const int a_stride, const int a_offset, const int b_stride, const int b_offset) {
  double det =
...
template<typename Accessor1, typename Accessor2, size_t block_size = 1>
inline void KalmanGainInv(const Accessor1 &a, const Accessor2 &b, MP3x3_ &c, const int tid, const int lay) {
