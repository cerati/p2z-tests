...
///TESTTTT
   ...
   std::unique_ptr<MPTRKNAccessor> chktrkNaccPtr(new MPTRKNAccessor(chktrkN));
   MPTRKNAccessor &chktrkNacc = *chktrkNaccPtr;

   auto &tmp_par = chktrkNacc.par;
#endif
