...
int main (int argc, char* argv[]) {
   ...
   for(itr=0; itr<NITER; itr++) {
     ...
     std::for_each(policy,
                   ...
                   [&, &outtrkNpar_ = *outtrkNaccPtr] (auto ii) {
...
auto tmp_par_local = outtrkNpar_.par(1);
...
#else
                     propagateToZ_mod(trkNacc, hitNacc, *outtrkNaccPtr, *errorPropAccPtr, *tempAccPtr, lid, llid, inner_loop_offset);
