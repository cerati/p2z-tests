...
void KalmanUpdate_mod(MP6x6SFAccessor  &trkErrAcc,
  ...
  auto inverse_temp   = inverse_tempAcc(); 
  auto kGain          = kGainAcc(); 
  auto newErr         = newErrAcc();
...
#pragma unroll    
  ...
  MultHelixPropTranspEndcap_mod<block_size>(errorPropAcc, tempAcc, obtracks.cov, lid, offset);
