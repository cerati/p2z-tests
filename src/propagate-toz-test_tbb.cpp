...
#pragma omp simd
  ...
  // printf("trkErr ");
  // for (int i = 0; i < 21; i++){
  //   printf("%10f ",trkErr->data[ i*bsize+0]);
  // }
  // printf("\n");
...
#pragma omp simd
  ...
  // printf("tmp newErr ");
  // for (int i = 0; i < 21; i++){
  //   printf("%10f ",newErr.data[ i*bsize+it]);
  // }
  // printf("\n");
