...
nvcc -arch=sm_86 -O3 --extended-lambda --expt-relaxed-constexpr --use_fast_math --default-stream per-thread -std=c++17 ./src/propagate-toz-test_cuda_native.cu -L -lcudart   -o ./"propagate_nvcc_cuda_native"
